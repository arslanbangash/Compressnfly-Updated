  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Learn the easiest way to compress PDF files online for free. Step-by-step guide with tips for students and professionals.",
      date: "2024-01-20",
      category: "Tutorial",
      readTime: "8 min read",
    ...
    },
    {
      ...
      excerpt:
        "Learn everything you need to know about compressing files efficiently while maintaining quality.",
      date: "2024-01-15",
      category: "Tutorial",
      readTime: "5 min read",
    ...
    },
    {
      ...
      excerpt:
        "Explore the importance of optimized file sizes for web performance and user experience.",
      date: "2024-01-10",
      category: "Insights",
      readTime: "3 min read",
    ...
    },
    {
      ...
      excerpt:
        "Discover the latest techniques for compressing video files without losing quality.",
      date: "2024-01-05",
      category: "Tutorial",
      readTime: "7 min read",
    ...
    },
    {
      ...
      excerpt:
        "A comprehensive comparison of different audio compression formats and their use cases.",
      date: "2024-01-01",
      category: "Guide",
      readTime: "4 min read",
