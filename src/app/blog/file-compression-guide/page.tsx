...
const FileCompressionGuide = () => {
  const content = (
    <>
      ...
      <p className="mb-6">
        File compression is the process of encoding information using fewer bits
        than the original representation. This technique reduces the size of
        files, making them easier to store, share, and transfer across networks.
      </p>
      ...
      <p className="mb-6">
        Lossless compression reduces file size without losing any data. When you
        decompress the file, you get back exactly the same data as the original.
        This is perfect for:
      </p>
      ...
      <p className="mb-6">
        ...
        some data. While you lose some information, the reduction is often
        imperceptible to humans. Common uses include:
      </p>
      <ul className="list-disc list-inside mb-6 space-y-2">
      ...
      <p className="mb-6">
        Compressnfly offers the perfect balance of compression efficiency and
        ease of use. Our advanced algorithms ensure maximum file size reduction
        while maintaining quality, and our web-based platform means no software
